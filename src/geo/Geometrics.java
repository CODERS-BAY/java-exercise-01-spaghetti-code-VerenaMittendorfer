...
public class Geometrics {
    ...
    public static void main(String[] args) {
        ...
        // System.out.println("Rectanglarea"e );
    ...
    public static int rectanglePerimeter(int x, int y) {
        System.out.println("Rectangle Perimeter x * y = " + x * y);
        return x * y;
        
    }

    public static int squarePerimeter(int x) {
        System.out.println("Square Perimeter 4 * x = " + 4 * y);
        return 4 * x;
    ...
    public static int squareArea (int x) {
        System.out.println("Square Area x = " + x * x);
        return x * x;
